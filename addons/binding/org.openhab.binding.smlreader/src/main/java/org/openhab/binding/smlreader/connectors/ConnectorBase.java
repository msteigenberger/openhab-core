...
abstract class ConnectorBase implements ISmlConnector {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(ConnectorBase.class);
     ...
     *
     */
    abstract protected void openConnection() throws IOException;
     ...
     *
     */
    abstract protected SML_File getMeterValuesInternal() throws IOException;
