...
public class SmlReaderBindingConstants {
    ...
    public final static ThingTypeUID THING_TYPE_SMLREADER = new ThingTypeUID(BINDING_ID, "meter");

    public final static String CONFIGURATION_PORT = "port";

    public final static String CONFIGURATION_CONVERSION = "conversionRatio";

    public final static String CHANNEL_PROPERTY_OBIS = "obis";
